 ...
 * Labelled text field.
 *
 * MUST stay at module scope. It was previously declared inside ContactForm's
 * render body, so every keystroke produced a new component identity — React
 * unmounted and remounted the input, the caret was lost, and the user had to
 * re-click the field before each character.
 */
